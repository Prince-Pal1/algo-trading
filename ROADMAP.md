...
**Test counts:** 1005 passing on `feat/gold-refactor` as of task #101 graveyard (734 baseline + G.0/G.0c/G.1/G.2a-G.2f/G.2g/G.2h + G.5/G.5b + Tier 5 M1 revival + graveyard).
