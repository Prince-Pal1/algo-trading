...
| TV Parity Framework | `src/backtest/tv_parity.py` | pandas, _alma, feature_engine | tv_parity_validate.py CLI + future Pine ports | ✅ 2026-04-14 task #104 (reusable library for Stage 0 Pine port validation — loaders, DST-aware anchor detection, lookahead ALMA crossover helper, reversal simulator, bar-by-bar + trade-by-trade matchers, Markdown report writer) |
