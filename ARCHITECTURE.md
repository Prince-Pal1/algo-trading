...
| Flow Monitor CLI | `scripts/flow_monitor.py` | Binance WS feed, all of `src/flow/` | Manual run | ✅ 2026-09-22 (`--symbol --depth --threshold --level-memory --no-turn --port`; uvloop; levels hot-reload every 10s) |
